...
// those joints back to identity — otherwise a viper that fought once keeps a kinked lower body
// forever, because nothing else ever touches tail0..tail4 again after slither stops driving them.
export const coilClip: Clip = {
  ...
  keyframes: [
    ...
    // Identity pin — see file-level comment above.
